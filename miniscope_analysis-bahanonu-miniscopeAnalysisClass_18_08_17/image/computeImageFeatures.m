function [imgStats] = computeImageFeatures(inputImages, varargin)
    ...
    % changelog
        % 2013.11.08 [09:24:12] removeSmallICs now calls a filterImages, name-change due to alteration in function, can slowly replace in codes
    ...
    for imageNo = 1:nImages
        ...
        for ifeature = options.featureList
