...
%%%%%%%%% Pasha temporary debuggimg %%%%%%%%% It is not clear what is
%%%%%%%%% options.p and the name of the function - "estimate_time_constants" - also
%%%%%%%%% doesn't match this one or anything else 
%         warning('No stable AR(%i) model found. Checking for AR(%i) model \n',options.p,options.p+1);
%         p = p + 1;
%         g = estimate_time_constants(y,p,sn,lags);
%%%%%%%%% Pasha temporary debuggimg
p = 5;
%%%%%%%%%%%%%%%%%
end
if p == 5
